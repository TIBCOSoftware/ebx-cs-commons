...
import com.tibco.ebx.cs.commons.lib.procedure.ExportCSVProcedure;
...
public class ExportCSVScheduledTask extends ScheduledTask {
	...
	public void execute(final ScheduledExecutionContext pContext) throws OperationException, ScheduledTaskInterruption {
		...
		try {
			AdaptationTable table = AdaptationUtils.getTable(pContext.getRepository(), this.dataSpace, this.dataSet, this.tablePath);
