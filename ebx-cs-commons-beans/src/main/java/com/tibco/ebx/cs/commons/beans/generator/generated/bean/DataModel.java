...
* It represents node at path /root/DataModel in data model urn:ebx:module:ebx-cs-commons:/WEB-INF/ebx/schemas/DataModels.xsd.
*
* @author EBX Commons
*/
public class DataModel extends TableBean {
	...
	*/
	...
	public DataAccessObject getDao() throws EBXCommonsException {
		if(this.dao == null && isBoundToEBX()){
			this.dao = DataAccessObjectDAO.getInstance().read(this, DataModelDAO.path_to_field_dao).orElse(null);
		}
		return this.dao;
	}

	public void setDao(final DataAccessObject dao){
		this.dao = dao;
	}
	...
	public List<RestService> getRsServices(final String predicate) {
		return RestServiceDAO.getInstance().readAll(this, DataModelDAO.path_to_field_rsServices, Optional.of(predicate));
	}
	...
	@Override
	public int hashCode() {
		return Objects.hash(identifier,moduleName,schemaLocation,dao,beansSourceFolder,daoSourceFolder,dtoSourceFolder,mappersSourceFolder,servicesSourceFolder,rsSourceFolder,beansPackage,daoPackage,dtoPackage,mappersPackage,servicesPackage,rsPackage);
	}
	...
	public boolean equals(final Object obj) {
		...
		return Objects.equals(identifier, other.identifier)
			 ...
			 && Objects.equals(beansPackage, other.beansPackage)
			 && Objects.equals(daoPackage, other.daoPackage)
			 && Objects.equals(dtoPackage, other.dtoPackage)
			 && Objects.equals(mappersPackage, other.mappersPackage)
			 && Objects.equals(servicesPackage, other.servicesPackage)
			 && Objects.equals(rsPackage, other.rsPackage);
	}
}