...
* It represents node at path /root/Table in data model urn:ebx:module:ebx-cs-commons:/WEB-INF/ebx/schemas/DataModels.xsd.
*
* @author EBX Commons
*/
	...
	*/
	...
	public DataAccessObject getDao() throws EBXCommonsException {
		if(this.dao == null && isBoundToEBX()){
			this.dao = DataAccessObjectDAO.getInstance().read(this, ModelTableDAO.path_to_field_dao).orElse(null);
		}
		return this.dao;
	}
	...
	public DataTransferObject getPreferredDTO() throws EBXCommonsException {
		if(this.preferredDTO == null && isBoundToEBX()){
			this.preferredDTO = DataTransferObjectDAO.getInstance().read(this, ModelTableDAO.path_to_field_preferredDTO).orElse(null);
		}
	...
	public List<DataTransferObject> getDtos(final String predicate) {
		return DataTransferObjectDAO.getInstance().readAll(this, ModelTableDAO.path_to_field_dtos, Optional.of(predicate));
	}
	...
	public List<RestService> getRsServices(final String predicate) {
		return RestServiceDAO.getInstance().readAll(this, ModelTableDAO.path_to_field_rsServices, Optional.of(predicate));
	}
	...
	@Override
	public int hashCode() {
		return Objects.hash(identifier,dataModel,pathInSchema,dao,javaBean,preferredDTO);
	}
	...
	public boolean equals(final Object obj) {
		...
		return Objects.equals(identifier, other.identifier)
			 ...
			 && Objects.equals(pathInSchema, other.pathInSchema)
			 && Objects.equals(dao, other.dao)
			 && Objects.equals(javaBean, other.javaBean)
			 && Objects.equals(preferredDTO, other.preferredDTO);
	}
}